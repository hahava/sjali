...
public class ExampleDetails {
    ...
    public ExampleDetails(int position){

        switch (position)
        {
            case 0:
                mainTitle = secondTitle = "스토리, 세대를 잇다!";
                secondDate = detDate = "2016_12_30";
                secondHost = "한국문화예술위원회";
                detAttend = "제한 없음";
                detContents = "세대간 서로의 삶을 이해할 수 있는 다양한 사건이나 문화, 생활 속에서 겪은 사연과 기록들을 바탕으로 작성" +
                        " 사실 위주의 사건 나열이 아닌 사건에 대한 당시의 생각, 필자의 견해 등도 함께 작성" +
                        " 집필자를 중심으로 윗세대의 삶, 아랫세대의 삶, 서로의 삶을 집필하는 것 모두 가능평전\n" ;
                detBenefits = "최우수 1편 500만원\n"+
                        "우수 2편 각100만원\n"+
                        "장려 3편 각 50만원\n";
                detReception = "홈페이지 접수 : inmun360.culture.go.kr을 통한 접수";
                detNotice = "- 응모작에 대한 저작권은 응모자에게 있으며, 국내·외의 저작권, 초상권에 저촉되지 않은 순수한 창작품이어야 한다.\n" +
                        "  - 한국문화예술위원회(이하 위원회)는 수상작에 한하여 저작자와 별도의 사용권한 협의 및 사용료 지불 없이 \n" +
                        "    인문360° 관련 사업의 사업 및 홍보 목적 달성을 위하여 필요한 한도 내에서 발표, 게시, 배포, \n";
                detContact = "공모전 운영사무국 : 02-6395-3127 (평일 09:00 ~ 18:00)";
                break;
            case 1:
                mainTitle = secondTitle = "보안취약점 자동분석 아이디어 공모전";
                secondDate = detDate = "2017_01_22";
                secondHost = "SW봉안국제공동연구센터";
                detAttend = "제한없음";
                detContents = "1. 보안 취약점 자동분석 기능 및 신규 취약점 분석에 관한 아이디어\n" +
                        "2. IoTcube 플랫폼의 개선, 확대 아이디어\n" +
                        "3. SW보안성 향상, 오픈소스 프로젝트 기여 사례 등 구체적인 활용 후기 등\n" +
                        "* 형식 무제한, 참가자 제한 없음 (논문, 시나리오, 수기, 보고사, 제안서 등 어떤 형태의 문서도 가능)\n";
                detBenefits = "- 대상 : 300만원, 컨퍼런스 발표\n" +
                        "- 최우수상 : 200만원, 컨퍼런스 발표\n" +
                        "- 우수상 : 100만원\n" +
                        "- 아이디어 창의상 : 아이패드 미니2\n" +
                        "- 아이디어 발굴상 : 아이패드 미니2\n" +
                        ...
                        "※ 시상내역은 향후 변경될 수 있습니다.";
                detReception = "- 전자파일로 작성하여 이메일 접수 (iotcube@concert.or.kr)\n" +
                ...
                detNotice = "Nothing";
                detContact = "한국침해사고대응팀협의회(CONCERT)사무국\n" +
                        "- Tel : 02-3474-2490\n" +
                        "- 홈페이지 : www.concert.or.kr";
                break;
            case 2:
                mainTitle = secondTitle = "2016 경북 스토리콘텐츠 공모전";
                secondDate = detDate = "2017_01_10";
                secondHost = "경상북도문화콘텐츠진흥원";
                detAttend = "제한없음";
                detContents = "- 경북문화자원을 소재로 활동한 웹소설, 웹툰, 웹드라마 3개 분야\n"+
                ...
                detReception = "우편접수 : 대구시 동구 동대구로 441 영남타워 6층 영남일보 편집국 영남일보 부설 한국스토리텔링연구원 <2016 칠곡 역사·문화 스토리텔링 전국 공모전> 담당자 앞 (겉봉투에 <2016 칠곡 역사·문화 스토리텔링 전국 공모전 응모작>이라고 명시할 것)\n" +
                        "∙ E-mail 접수 : story@yeongnam.com";
                detNotice = " 기발표된 작품(출판, 공연, 문학지 게재 등)이나 타 공모전 수상작품은 심사에서 제외\n" +
                ...
                detContact = "영남일보 부설 한국스토리텔링연구원 053)757-5245, 5258";
                break;
            case 3:
                mainTitle = secondTitle = "제3회 레진코믹스";
                secondDate = detDate = "2017_02_28";
                secondHost = "레진코믹스";
                detAttend = "제한없음";
                detContents = "- BL, 백합, 성인 등 모든 장르";
                detBenefits = "- 대상(1작품) : 상금 1억원, 글로벌 진출 기회, CLIP STUDIO PAINT EX\n" +
                ...
                detReception =
                        ...
                        "- 이메일 : contest@lezhin.";
                detNotice = "- 스크롤 만화 최소 2화 이사잉라면 무조건 심사";
                detContact = "- E-mail : contest_help@lezhin.com";
                break;
            case 4:
                mainTitle = secondTitle = "서울백병원 개원 85주년 UCC 공모전";
                secondDate = detDate = "2017_03_31";
                secondHost = "서울백병원";
                detAttend = "제한없음";
                detContents = "- 서울백병원의 사랑, 감동, 희망을 주제로 다큐, CF, 드라마 등 형식에 상관없이 자유롭게 만들어주세요.\n"+
                        "- avi, mp4, mov, wmv";
                detBenefits = "- 대상(1명) : 100만원\n" +
                        "- 우수상(2명) : 50만원\n" +
                        "- 장려상(5명) : 10만원";
                detReception =
                        "- 동영상 파일을 E-mail 전송 또는 Youtube에 업로드 후 URL 입력\n" +
                        "* E-mail : seoulpaik85@paik.ac.";
                detNotice = "1. 응모하는 모든 컨텐츠의 저작권(음원, 이미지)의 사용은 법적인 문제가 없어야 합니다.\n" +
                ...
                detContact = "http://www.paik.ac.kr/seoul/";
                break;
        }
    }
}
